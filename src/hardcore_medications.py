...
PUSHES = [
    ...
    ('calcium-gluconate', 'Calcium gluconate', 120, 'At the full 3 g replacement reference, 120 seconds delivers 139.5 mg/min elemental calcium, above the 100 mg/min fast-rate onset. A 300-second delivery gives 55.8 mg/min; earlier doses still matter.', 'Normal mode spreads manual toxicity input over a reference window. This salt remains distinct from calcium chloride.'),
