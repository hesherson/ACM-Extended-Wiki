...
<summary><span class="dd-mark"></span><span class="infusion-heading"><span class="dd-name">{escape(row['name'])}</span><span class="infusion-summary">{escape(row['summary'])}</span></span><span class="infusion-category">{escape(row['group'])}</span></summary>
<div class="dd-body"><div class="infusion-bands">
